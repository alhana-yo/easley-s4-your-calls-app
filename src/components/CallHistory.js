                        ...
                        <th colspan="2" className="cell table__date">
                          <div className="main__subtitle--date-container">
                              <div className="dateStart">
                                ...
                                <input id="dateStart" type="text" className="input-date" placeholder="Desde: 26/02/1991" onKeyUp={this.props.actionGetStartDate}/>
                              </div>
                              <div className="dateEnd">
                                <label htmlFor="dateEnd" ></label>
                                <input id="dateEnd" type="text" className="input-date" placeholder="Hasta: 26/03/2019" onKeyUp={this.props.actionGetEndDate}/>
                              </div>
                          </div>
